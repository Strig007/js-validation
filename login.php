...
<body>
    ...
    <fieldset>
            ...
            <input type="text" id="uname" name="uname" value="<?php echo $uid;?>"> <span style="color: red;" id="uerror">* <?php echo $userNameErr;?></span>
            <br><br>
            <label for="password">Password: </label>
            <input type="password" id="password" name="password"> <span style="color: red;" id="perror">* <?php echo $passwordErr;?></span>
            <br><br>
