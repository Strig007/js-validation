...
<body>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" name="registrationForm"
        onsubmit="return isValidForm()">
        <fieldset>
            <legend>Basic Information:</legend>
            <br>
            <label for="fname">First Name: </label>
            <input type="text" id="fname" name="fname"> <span style="color: red;" id="ferror">* <?php echo $firstNameErr;?></span>
            <br><br>
            <label for="lname">Last Name: </label>
            <input type="text" id="lname" name="lname"> <span style="color: red;" id="lerror">* <?php echo $lastNameErr;?></span>
            <br><br>
            ...
            <label for="gender">Female</label> <span style="color: red;" id="generror">* <?php echo $genderErr;?></span>
            <br><br>

            <label for="dob">Date of Birth: </label>
            <input type="date" id="dob" name="dob"> <span style="color: red;" id="doberror">* <?php echo $dobErr;?></span>
            <br><br>
            ...
            <span style="color: red;" id="relierror">* <?php echo $religionErr;?></span>
            <br>
        </fieldset>
        <br>
        ...
        <fieldset>
            ...
            <input type="email" id="email" name="email"> <span style="color: red;" id="emerror">* <?php echo $emailErr;?></span>
            <br><br>
        ...
        <fieldset>
            ...
            <input type="text" id="uname" name="uname"> <span style="color: red;" id="uerror">* <?php echo $userNameErr;?></span>
            <br><br>
            <label for="password">Password: </label>
            <input type="password" id="password" name="password"> <span style="color: red;" id="passerror">* <?php echo $passwordErr;?></span>
        </fieldset>
        <br>
    ...
    <script>
        function isValidForm()
        {
            ...
            var firstnameError = document.getElementById("ferror");
            var lastnameError = document.getElementById("lerror");
            var genderError = document.getElementById("generror");
            var dobError = document.getElementById("doberror");
            var religionError = document.getElementById("relierror");
            ...
            if (religion == "")
            {
                religionError.innerHTML = "Please select a religion!";
                flag = false;
            }
            if (email == "")
            {
            ...
            if (username == "")
            {
                usernameError.innerHTML = "Please provide an username!";
                flag = false;
            }
            if (password == "")
            {
